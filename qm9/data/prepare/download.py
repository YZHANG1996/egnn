...
def prepare_dataset(datadir, dataset, subset=None, splits=None, cleanup=True, force_download=False, noopt_geom=False):
    """
    ...
    if new_download or force_download:
        ...
        if dataset.lower().startswith('qm9'):
            download_dataset_qm9(datadir, dataset, splits, cleanup=cleanup, noopt_geom=noopt_geom)
